        ...
        if (kIsWeb) {
            ...
            if (mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Web Localhost: Using Mock Location')),
              );
            }
            return;
        }
            ...
            children: [
              ...
              Container(
                ...
                child: ListTile(
                  ...
                  leading: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _gpsLocation != null ? const Color(0xFFECFDF5) : Colors.grey.shade100,
                      shape: BoxShape.circle,
                    ),
                    child: Icon(
                      Icons.location_on_rounded, 
                      color: _gpsLocation != null ? const Color(0xFF10B981) : Colors.grey.shade500
                    ),
                  ),
                  title: Text(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _nextStep,
                  child: const Text("Next Step: Family Members", style: TextStyle(fontSize: 18)),
                ),
              ),
            ],
          ),
