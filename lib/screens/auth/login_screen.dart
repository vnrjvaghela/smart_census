...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _verifyOTP() async {
    ...
    // ✅ TEST MODE BYPASS
    if (_phoneController.text.trim() == _testPhone &&
  ...
  TextStyle? jsonify_style_placeholder() =>
      GoogleFonts.outfit(color: Colors.grey.shade400, letterSpacing: 8);
}
